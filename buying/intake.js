export const fields = [
  ...
  { key: 'trade_in', label: 'Trade-in', question: 'Do you have a car you’d like to trade in?', placeholder: 'For example, a 2018 Civic with 70,000 miles', mobilePlaceholder: 'e.g. 2018 Civic, 70k mi', choices: ['No trade-in', 'Yes, I have a trade-in', 'Not sure yet'], hint: 'If so, a make, model, and approximate mileage help.', intake: true, direct: true, priority: false },
