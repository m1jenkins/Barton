...
Evidence files: [sanitized audit snapshot](2026-09-25-seo-audit-evidence.json), [interactive review](.lavish/2026-09-25-seo-plan/index.html). Raw public fetches are retained locally in `/private/tmp/barton-seo-audit-2026-09-25/`; this temporary folder is not the durable record. Both plan and review are under `docs/`, which the existing `.vercelignore` excludes from deployment.
